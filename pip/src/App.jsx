...
function App() {
  ...
  const [events, setEvents] = useState([
    { title: "A in Germany", date: "2025-06-01", category: "Atticus" },
    { title: "A in Germany", date: "2025-06-02", category: "Atticus" },
    { title: "A in Germany", date: "2025-06-03", category: "Atticus" },
    { title: "Beach Day", date: "2025-05-31", category: "Family" },
    { title: "No School", date: "2025-06-01", category: "Kids" },
    { title: "Pool Day", date: "2025-06-01", category: "Kids" },
    ...
    { title: "Harper's Graduation", date: "2025-06-05", category: "Family" },
    { title: "Jackson's Class Party", date: "2025-06-14", category: "Family" },
    { title: "Last Day of School", date: "2025-06-27", category: "Kids" },
    { title: "Move to the Inn", date: "2025-06-29", category: "Family" },
    { title: "Maggie Fly to VCE", date: "2025-06-16", category: "Family" },
    { title: "Ederle Inn", date: "2025-06-29", category: "Family" },
    { title: "Ederle Inn", date: "2025-06-30", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-01", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-02", category: "Family" },
    { title: "Crete", date: "2025-07-03", category: "Family" },
    { title: "Crete", date: "2025-07-04", category: "Family" },
    { title: "Crete", date: "2025-07-05", category: "Family" },
    { title: "Crete", date: "2025-07-06", category: "Family" },
    { title: "Crete", date: "2025-07-07", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-07", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-08", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-09", category: "Family" },
    { title: "Ederle Inn", date: "2025-07-10", category: "Family" },
    { title: "UAB & CFMO Pickup", date: "2025-06-30", category: "Family" },
    { title: "Clean the house", date: "2025-06-29", category: "Carrie" },
    { title: "Fly to ATL", date: "2025-07-10", category: "Family" },
    { title: "Atticus Drive to Kansas", date: "2025-07-15", category: "Family" },
    { title: "Fly to ATL", date: "2025-07-10", category: "Family" },
  ]);
